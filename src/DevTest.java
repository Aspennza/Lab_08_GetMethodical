...
public class DevTest
{
    public static void main(String[] args)
    {
        ...
        testBoolean = getYNConfirm(in, "Please enter Y or N");
        System.out.println("\nYour boolean is: " + testBoolean + ".");

        testRegEx = getRegExString(in, "Please enter your email address", "[a-zA-Z0-9]+@[a-zA-Z0-9]+[\\.][a-z]+");
        System.out.println("\nYour regEx answer is: " + testRegEx + ".");
    }
